<?php
    ...
    if ($page_name == 'index.php') $page_name = 'gallery.php';
?>
					...
					<ul class="menu controls">
                        <?php
                            ...
                            foreach ($pages as $file) {
                                ...
                                $page = $file;
                                if ($page == 'index.php') $page = 'galery';

                                if ($page_name == $page) echo '<li data-from="left"><a href="'.$page.'"><strong>'.basename($page, '.php').'</strong></a></li>';
                                else echo '<li data-from="left"><a href="'.$file.'">'.basename($page, '.php').'</a></li>';
                            }
						?>
					</ul>
				</div>